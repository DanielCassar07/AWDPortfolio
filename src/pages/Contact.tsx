...
import { setErrors, setField, clearStatusMessages } from "../features/contact/contactSlice";
...
function validate(values: ContactFormValues): ContactErrors {
  ...
  else if (msg.length < 10) errors.message = "Message should be at least 10 characters.";
...
export default function Contact() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    await dispatch(sendContactForm(values));
  }
